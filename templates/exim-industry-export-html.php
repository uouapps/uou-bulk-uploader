<div class="wrap" id="globo_exim_export_wrap">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="active"><a href="<?php echo esc_url( admin_url( 'admin.php?page=uou_uploader_industry_export' ) ) ?>"><?php _e('Industry Export', 'globo') ?></a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
    ...
    <div class="container">
        <h1><?php _e('Globo Industry Blank CSV Template', 'globo') ?></h1>
        <form>
            <input type="hidden" name="globo_export_download" id="globo_export_download" value="industry">
            <button id="globo_export_download_btn" class="btn btn-info"><?php _e('Download Industry Blank CSV Template', 'globo') ?></button>    
        </form>
        ...
        <form id="hiddenform" method="POST" action="<?php echo esc_url( admin_url( 'admin-ajax.php') . '?action=globo_exim_export_template_download' ) ?>">
            <input type="hidden" id="globo_type" name="globo_type" value="industry">
