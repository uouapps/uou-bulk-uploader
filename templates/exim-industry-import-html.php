<div class="wrap" id="globo_exim_export_wrap">
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="active"><a href="<?php echo esc_url( admin_url( 'admin.php?page=uou_uploader_industry_import' ) ) ?>"><?php _e('Industry Import', 'globo') ?></a></li>
    ...
    <div class="container">
        ...
        <div id="globo_hide">
            <form id="import-industry-form" method="post">
                <input id="import-csv-file" name="iimport-csv-file" type="hidden" value="">
                <button id="import-industry" class="btn btn-danger pull-right mt5"><?php _e('Import Industry', 'globo') ?></button>
            </form>

            <div class="alert alert-success">
                <p id="import-result"><span class="globo-exim-icon"><i class="glyphicon glyphicon-refresh fa-spin"></i> <?php _e('Industry Importing...', 'globo') ?></span>&nbsp;</p>
            </div>
        </div>
    </div>
</div>
